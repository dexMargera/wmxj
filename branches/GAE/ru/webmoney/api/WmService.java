...
import ru.webmoney.api.dict.PurseNumber;
import ru.webmoney.api.dict.WmDate;
import ru.webmoney.api.dict.Wmid;
import ru.webmoney.api.dict.X18AuthType;
import ru.webmoney.api.dict.X19Operation;
import ru.webmoney.api.dict.X19UserInfo;
import ru.webmoney.api.req.RequestNumberGenerator;
import ru.webmoney.api.req.X10Request;
import ru.webmoney.api.req.X11Request;
import ru.webmoney.api.req.X13Request;
import ru.webmoney.api.req.X14Request;
import ru.webmoney.api.req.X15RequestList;
import ru.webmoney.api.req.X15RequestSave;
import ru.webmoney.api.req.X16Request;
import ru.webmoney.api.req.X17Request;
import ru.webmoney.api.req.X18Request;
import ru.webmoney.api.req.X19Request;
import ru.webmoney.api.req.X1Request;
import ru.webmoney.api.req.X2Request;
import ru.webmoney.api.req.X3Request;
import ru.webmoney.api.req.X4Request;
import ru.webmoney.api.req.X5Request;
import ru.webmoney.api.req.X6Request;
import ru.webmoney.api.req.X7Request;
import ru.webmoney.api.req.X8Request;
import ru.webmoney.api.req.X9Request;
import ru.webmoney.api.req.XmlRequest;
import ru.webmoney.api.resp.X10Response;
import ru.webmoney.api.resp.X11Response;
import ru.webmoney.api.resp.X13Response;
import ru.webmoney.api.resp.X14Response;
import ru.webmoney.api.resp.X15ResponseList;
import ru.webmoney.api.resp.X15ResponseSave;
import ru.webmoney.api.resp.X16Response;
import ru.webmoney.api.resp.X17Response;
import ru.webmoney.api.resp.X18Response;
import ru.webmoney.api.resp.X19Response;
import ru.webmoney.api.resp.X1Response;
import ru.webmoney.api.resp.X2Response;
import ru.webmoney.api.resp.X3Response;
import ru.webmoney.api.resp.X4Response;
import ru.webmoney.api.resp.X5Response;
import ru.webmoney.api.resp.X6Response;
import ru.webmoney.api.resp.X7Response;
import ru.webmoney.api.resp.X8Response;
import ru.webmoney.api.resp.X9Response;
import ru.webmoney.api.resp.sax.X10ResponseHandler;
import ru.webmoney.api.resp.sax.X11ResponseHandler;
import ru.webmoney.api.resp.sax.X13ResponseHandler;
import ru.webmoney.api.resp.sax.X14ResponseHandler;
import ru.webmoney.api.resp.sax.X15ResponseListHandler;
import ru.webmoney.api.resp.sax.X15ResponseSaveHandler;
import ru.webmoney.api.resp.sax.X16ResponseHandler;
import ru.webmoney.api.resp.sax.X17ResponseHandler;
import ru.webmoney.api.resp.sax.X18ResponseHandler;
import ru.webmoney.api.resp.sax.X19ResponseHandler;
import ru.webmoney.api.resp.sax.X1ResponseHandler;
import ru.webmoney.api.resp.sax.X2ResponseHandler;
import ru.webmoney.api.resp.sax.X3ResponseHandler;
import ru.webmoney.api.resp.sax.X4ResponseHandler;
import ru.webmoney.api.resp.sax.X5ResponseHandler;
import ru.webmoney.api.resp.sax.X6ResponseHandler;
import ru.webmoney.api.resp.sax.X7ResponseHandler;
import ru.webmoney.api.resp.sax.X8ResponseHandler;
import ru.webmoney.api.resp.sax.X9ResponseHandler;
import ru.webmoney.cryptography.Signer;
...
public class WmService {
	...
	/**
	 * WMID для авторизации по схеме Classic.
	 */
	 ...
	 */
	private XmlRequest initSignature(XmlRequest request) throws IOException{
	...
	/**
	 * �?нициирует WmSigner с использованием ключа из Base64-кодированной строки.
	 * 
	 * @param wmid
	 ...
	 */
	public void initWmSigner(Wmid wmid, byte[] exponent, byte[] modulus) {
		this.signerWmId = wmid;
		this.signer = new Signer(exponent, modulus);
	}
	...
	private String sendHttpRequest(String host, String requestAddress,
		...
		this.xmlResponse = this.httpResponse;
	 ...
	 * @throws Exception
	 */
	public X1Response x1(X1Request req) throws IOException {
	 ...
	 * @throws Exception
	 */
	public X6Response x6(X6Request req) throws IOException {
		// авторизация по схеме Light
		String host = WMT_HOST_LIGHT;
